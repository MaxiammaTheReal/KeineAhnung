-- Name: t
-- Path: game:GetService("ReplicatedStorage").Packages._Index.osyrisrblx_t@3.1.1.t
-- Class: ModuleScript
-- Exploit: Xeno 
-- Time to decompile: 0.8008779000010691 seconds
...
-- Decompiled on 2026-02-18 15:19:33
-- Luau version 6, Types version 3
-- Time taken: 0.032908 seconds
...
local module_2_upvr = {
	...
	typeof = function(arg1) -- Line 16, Named "typeof"
		return function(arg1_3) -- Line 17
			...
			local typeof_result1_3 = typeof(arg1_3)
			if typeof_result1_3 == arg1 then
				return true
			end
			return false, string.format("%s expected, got %s", arg1, typeof_result1_3)
		end
	end;
	...
	buffer = module_2_upvr.typeof("buffer");
	...
	vector = module_2_upvr.type("vector");
	number = function(arg1) -- Line 134, Named "number"
		...
		return false, string.format("number expected, got %s", typeof_result1_2)
	end;
	nan = function(arg1) -- Line 154, Named "nan"
...
function module_2_upvr.literal(...) -- Line 518
	--[[ Upvalues[1]:
...
function module_2_upvr.keyOf(arg1) -- Line 553
	--[[ Upvalues[1]:
		[1]: module_2_upvr (readonly)
	]]
	local module_3 = {}
...
function module_2_upvr.valueOf(arg1) -- Line 571
	--[[ Upvalues[1]:
		[1]: module_2_upvr (readonly)
	]]
	local module = {}
...
function module_2_upvr.integer(arg1) -- Line 589
	--[[ Upvalues[1]:
		[1]: module_2_upvr (readonly)
	]]
	local any_number_result1_2, any_number_result2_5 = module_2_upvr.number(arg1)
...
function module_2_upvr.numberMin(arg1) -- Line 609
	--[[ Upvalues[1]:
		[1]: module_2_upvr (readonly)
	]]
	return function(arg1_4) -- Line 610
		--[[ Upvalues[2]:
			[1]: module_2_upvr (copied, readonly)
			[2]: arg1 (readonly)
		]]
		local any_number_result1, any_number_result2_2 = module_2_upvr.number(arg1_4)
...
function module_2_upvr.numberMax(arg1) -- Line 631
	--[[ Upvalues[1]:
		[1]: module_2_upvr (readonly)
	]]
	return function(arg1_5) -- Line 632
		--[[ Upvalues[2]:
			[1]: module_2_upvr (copied, readonly)
			[2]: arg1 (readonly)
		]]
		local any_number_result1_3, any_number_result2_3 = module_2_upvr.number(arg1_5)
		if not any_number_result1_3 then
			return false, any_number_result2_3
		end
		if arg1_5 <= arg1 then
			return true
		end
...
function module_2_upvr.numberMinExclusive(arg1) -- Line 653
	--[[ Upvalues[1]:
		[1]: module_2_upvr (readonly)
	]]
	return function(arg1_6) -- Line 654
		--[[ Upvalues[2]:
			[1]: module_2_upvr (copied, readonly)
			[2]: arg1 (readonly)
		]]
		local any_number_result1_4, any_number_result2 = module_2_upvr.number(arg1_6)
...
function module_2_upvr.numberMaxExclusive(arg1) -- Line 675
	--[[ Upvalues[1]:
		[1]: module_2_upvr (readonly)
	]]
	return function(arg1_7) -- Line 676
		--[[ Upvalues[2]:
			[1]: module_2_upvr (copied, readonly)
			[2]: arg1 (readonly)
		]]
		local any_number_result1_5, any_number_result2_4 = module_2_upvr.number(arg1_7)
		if not any_number_result1_5 then
			return false, any_number_result2_4 or ""
		end
		if arg1_7 < arg1 then
			return true
		end
...
function module_2_upvr.numberConstrained(arg1, arg2) -- Line 712
	--[[ Upvalues[1]:
		[1]: module_2_upvr (readonly)
	]]
	...
	return function(arg1_8) -- Line 718
		--[[ Upvalues[2]:
		...
		local any_numberMax_result1_upvr_result1, var47_result2 = any_numberMax_result1_upvr(arg1_8)
		if not any_numberMax_result1_upvr_result1 then
			return false, var47_result2 or ""
		end
		return true
	end
end
function module_2_upvr.numberConstrainedExclusive(arg1, arg2) -- Line 741
	--[[ Upvalues[1]:
		[1]: module_2_upvr (readonly)
	]]
	assert(module_2_upvr.number(arg1))
	...
	return function(arg1_9) -- Line 747
		--[[ Upvalues[2]:
...
function module_2_upvr.match(arg1) -- Line 769
	--[[ Upvalues[1]:
		[1]: module_2_upvr (readonly)
	]]
	assert(module_2_upvr.string(arg1))
	return function(arg1_10) -- Line 771
		--[[ Upvalues[2]:
			[1]: module_2_upvr (copied, readonly)
			[2]: arg1 (readonly)
		]]
...
function module_2_upvr.optional(arg1) -- Line 792
	--[[ Upvalues[1]:
		[1]: module_2_upvr (readonly)
	]]
	assert(module_2_upvr.callback(arg1))
	return function(arg1_11) -- Line 794
		--[[ Upvalues[1]:
			[1]: arg1 (readonly)
		]]
		if arg1_11 == nil then
		...
		local arg1_result1_2, arg1_result2 = arg1(arg1_11)
		if arg1_result1_2 then
			return true
		end
		return false, string.format("(optional) %s", arg1_result2 or "")
	end
end
function module_2_upvr.tuple(...) -- Line 815
...
function module_2_upvr.keys(arg1) -- Line 837
	--[[ Upvalues[1]:
		[1]: module_2_upvr (readonly)
	]]
	assert(module_2_upvr.callback(arg1))
	return function(arg1_12) -- Line 839
		--[[ Upvalues[2]:
			[1]: module_2_upvr (copied, readonly)
			[2]: arg1 (readonly)
		]]
		local any_table_result1_3, any_table_result2_4 = module_2_upvr.table(arg1_12)
...
function module_2_upvr.values(arg1) -- Line 863
	--[[ Upvalues[1]:
		[1]: module_2_upvr (readonly)
	]]
	assert(module_2_upvr.callback(arg1))
	return function(arg1_13) -- Line 865
		--[[ Upvalues[2]:
			[1]: module_2_upvr (copied, readonly)
			[2]: arg1 (readonly)
		]]
		local any_table_result1, any_table_result2_3 = module_2_upvr.table(arg1_13)
		if any_table_result1 == false then
			return false, any_table_result2_3 or ""
		end
		for i_6, v_3 in pairs(arg1_13) do
			local arg1_result1_3, arg1_result2_2 = arg1(v_3)
			if arg1_result1_3 == false then
...
function module_2_upvr.map(arg1, arg2) -- Line 890
	--[[ Upvalues[1]:
		[1]: module_2_upvr (readonly)
	]]
	assert(module_2_upvr.callback(arg1))
	...
	return function(arg1_14) -- Line 896
		--[[ Upvalues[2]:
			[1]: any_keys_result1_upvr_2 (readonly)
			[2]: any_values_result1_upvr_2 (readonly)
		]]
		local any_keys_result1_upvr_2_result1, any_keys_result1_upvr_2_result2 = any_keys_result1_upvr_2(arg1_14)
		if not any_keys_result1_upvr_2_result1 then
			return false, any_keys_result1_upvr_2_result2 or ""
		end
...
function module_2_upvr.set(arg1) -- Line 918
	--[[ Upvalues[1]:
		[1]: module_2_upvr (readonly)
	]]
...
function module_2_upvr.array(arg1) -- Line 931
	--[[ Upvalues[2]:
		[1]: module_2_upvr (readonly)
	...
	return function(arg1_15) -- Line 935
		--[[ Upvalues[2]:
...
function module_2_upvr.strictArray(...) -- Line 971
	--[[ Upvalues[2]:
		[1]: module_2_upvr (readonly)
		[2]: any_keys_result1_upvr (readonly)
	]]
...
function module_2_upvr.intersection(...) -- Line 1034
	--[[ Upvalues[1]:
		[1]: var130_upvr (readonly)
	]]
	local args_list_upvr = {...}
	assert(var130_upvr(args_list_upvr))
	return function(arg1) -- Line 1038
		--[[ Upvalues[1]:
...
function module_2_upvr.interface(arg1) -- Line 1065
	--[[ Upvalues[2]:
		[1]: strict_upvr (readonly)
		[2]: module_2_upvr (readonly)
	]]
	assert(strict_upvr(arg1))
	return function(arg1_16) -- Line 1067
		--[[ Upvalues[2]:
			[1]: module_2_upvr (copied, readonly)
			[2]: arg1 (readonly)
		]]
		local any_table_result1_2, any_table_result2_2 = module_2_upvr.table(arg1_16)
...
function module_2_upvr.strictInterface(arg1) -- Line 1091
	--[[ Upvalues[2]:
		[1]: strict_upvr (readonly)
		[2]: module_2_upvr (readonly)
	]]
	assert(strict_upvr(arg1))
	return function(arg1_17) -- Line 1093
		--[[ Upvalues[2]:
			[1]: module_2_upvr (copied, readonly)
			[2]: arg1 (readonly)
		]]
		local any_table_result1_4, any_table_result2 = module_2_upvr.table(arg1_17)
...
function strict_upvr(arg1, arg2) -- Line 1124, Named "instanceOf"
	--[[ Upvalues[1]:
		[1]: module_2_upvr (readonly)
	]]
	assert(module_2_upvr.string(arg1))
	...
	return function(arg1_18) -- Line 1132
		--[[ Upvalues[3]:
			[1]: module_2_upvr (copied, readonly)
			[2]: arg1 (readonly)
			[3]: var172_upvw (read and write)
		]]
		local any_Instance_result1_4, any_Instance_result2_2 = module_2_upvr.Instance(arg1_18)
		...
		if var172_upvw then
			local var172_upvw_result1, var172_result2 = var172_upvw(arg1_18)
			if not var172_upvw_result1 then
...
function strict_upvr(arg1, arg2) -- Line 1162, Named "instanceIsA"
	--[[ Upvalues[1]:
		[1]: module_2_upvr (readonly)
	]]
	assert(module_2_upvr.string(arg1))
	...
	return function(arg1_19) -- Line 1170
		--[[ Upvalues[3]:
			[1]: module_2_upvr (copied, readonly)
			[2]: arg1 (readonly)
		...
		if var182_upvw then
			local var182_upvw_result1, var182_result2_2 = var182_upvw(arg1_19)
			if not var182_upvw_result1 then
...
function strict_upvr(arg1) -- Line 1198, Named "enum"
	--[[ Upvalues[1]:
		[1]: module_2_upvr (readonly)
	]]
	assert(module_2_upvr.Enum(arg1))
	return function(arg1_20) -- Line 1200
		--[[ Upvalues[2]:
			[1]: module_2_upvr (copied, readonly)
			[2]: arg1 (readonly)
		]]
...
function module_2_upvr.wrap(arg1, arg2) -- Line 1225
	--[[ Upvalues[1]:
		[1]: strict_upvr (readonly)
	]]
...
function strict_upvr(arg1) -- Line 1241, Named "strict"
...
function module_2_upvr.children(arg1) -- Line 1261
	--[[ Upvalues[2]:
		[1]: strict_upvr (readonly)
		[2]: module_2_upvr (readonly)
	]]
	assert(strict_upvr(arg1))
	return function(arg1_21) -- Line 1264
		--[[ Upvalues[2]:
			[1]: module_2_upvr (copied, readonly)
			[2]: arg1 (readonly)
		]]
		local any_Instance_result1, any_Instance_result2_3 = module_2_upvr.Instance(arg1_21)
		if not any_Instance_result1 then
			return false, any_Instance_result2_3 or ""
		end
		local tbl = {}
