-- Name: signal
-- Path: game:GetService("ReplicatedStorage").Packages._Index.sleitnick_signal@2.0.3.signal
-- Class: ModuleScript
-- Exploit: Xeno 
-- Time to decompile: 0.6546821000010823 seconds
...
function tbl_4_upvr.Destroy(arg1) -- Line 409
	arg1:DisconnectAll()
...
setmetatable(tbl_4_upvr, {
	__index = function(arg1, arg2) -- Line 420, Named "__index"
		error("Attempt to get Signal::%s (not a valid member)":format(tostring(arg2)), 2)
	end;
	__newindex = function(arg1, arg2, arg3) -- Line 423, Named "__newindex"
